...
bert_models = ['bert-base-uncased'] + [os.path.join(bert_models_dir, m) for m in os.listdir(bert_models_dir)]

roberta_models_dir = os.path.join(base_dir, "roberta models")
roberta_models = ['roberta-base'] + [os.path.join(roberta_models_dir, m) for m in os.listdir(roberta_models_dir)]

distil_models_dir = os.path.join(base_dir, "distilbert models")
distil_models = ['distilbert-base-uncased']+ [os.path.join(distil_models_dir, m) for m in os.listdir(distil_models_dir)]
